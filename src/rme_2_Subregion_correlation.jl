...
# target_reefs_mgmt = lagged_analysis_mgmt[(lagged_analysis_mgmt[:,"lag4"] .>= 0.8), :RME_UNIQUE_ID]

# lagged_analysis_mgmt_evenness = subregion_analysis(management_regions, taxa_evenness, context_layers, :management_area, 1:10)
# target_reefs_mgmt_evenness = lagged_analysis_mgmt_evenness[(lagged_analysis_mgmt_evenness[:,"lag5"] .>= 0.8), :RME_UNIQUE_ID]
...
# target_reefs_subr = lagged_analysis_subregion[(lagged_analysis_subregion[:,"lag4"] .>= 0.8), :RME_UNIQUE_ID]

# lagged_analysis_subregion_evenness = subregion_analysis(port_subregions, taxa_evenness, context_layers, :closest_port, 1:10)
# target_reefs_subr_evenness = lagged_analysis_subregion_evenness[(lagged_analysis_subregion_evenness[:,"lag5"] .>= 0.8), :RME_UNIQUE_ID]
...
context_layers = leftjoin(context_layers, lagged_analysis_bior[:, ["lag4", "RME_UNIQUE_ID"]], on=:RME_UNIQUE_ID)
...
context_layers = leftjoin(context_layers, lagged_analysis_bior_evenness[:, ["lag5", "RME_UNIQUE_ID"]], on=:RME_UNIQUE_ID)
rename!(context_layers, :lag5 => :lag5_bior_evenness)
context_layers.lag5_bior_evenness = ifelse.(isnan.(context_layers.lag5_bior_evenness), 0.0, context_layers.lag5_bior_evenness)
...
context_layers.target_reefs_bior = context_layers.lag4_bior .> 0.8
...
context_layers.target_reefs_bior_evenness = context_layers.lag5_bior_evenness .> 0.8
